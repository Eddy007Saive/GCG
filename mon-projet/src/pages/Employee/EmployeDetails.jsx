  ...
  return (
    <section className="bg-white shadow-xl rounded-lg p-6 max-w-4xl mx-auto">
      <div className="flex gap-6">
        <div className="relative w-1/4 h-48 bg-gray-200 dark:bg-gray-700 overflow-hidden rounded-lg">
          <img src="" alt="Employé" className="object-cover w-full h-full" />
        </div>
        <div className="w-3/4 bg-gray-50 p-4 rounded-lg shadow-md">
          <div className="space-y-4">
            ...
            <div className="flex justify-between">
              <label htmlFor="nom" className="font-semibold text-gray-800 dark:text-white">Sexe:</label>
      ...
      <div className="mt-6">
        <div className="w-full bg-gray-50 p-4 rounded-lg shadow-md">
          <div className="space-y-4">
            ...
            <div className="flex justify-between">
              <label htmlFor="conge" className="font-semibold text-gray-800 dark:text-white">Poste:</label>
              <p className=" text-gray-900 dark:text-gray-200">{employe.poste}</p>
            </div>

            <div className="flex justify-between">
              <label htmlFor="conge" className="font-semibold text-gray-800 dark:text-white">Département:</label>
              <p className=" text-gray-900 dark:text-gray-200">{employe.departement} </p>
            </div>
          </div>
        </div>
      </div>
      <div className="w-full flex  flex-end gap-4  p-3  ">
        <Link to={`/dashboard/employe/employe_update/${employe.id}`} className='bg-yellow-200 p-3 rounded-lg hover:bg-yellow-500 '>
        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="size-6">
          <path stroke-linecap="round" stroke-linejoin="round" d="M16.023 9.348h4.992v-.001M2.985 19.644v-4.992m0 0h4.992m-4.993 0 3.181 3.183a8.25 8.25 0 0 0 13.803-3.7M4.031 9.865a8.25 8.25 0 0 1 13.803-3.7l3.181 3.182m0-4.991v4.99" />
        </svg>

        </Link>
        <button className='bg-red-200 p-3 rounded-lg hover:bg-red-500 '><svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="size-6">
                <path stroke-linecap="round" stroke-linejoin="round" d="m14.74 9-.346 9m-4.788 0L9.26 9m9.968-3.21c.342.052.682.107 1.022.166m-1.022-.165L18.16 19.673a2.25 2.25 0 0 1-2.244 2.077H8.084a2.25 2.25 0 0 1-2.244-2.077L4.772 5.79m14.456 0a48.108 48.108 0 0 0-3.478-.397m-12 .562c.34-.059.68-.114 1.022-.165m0 0a48.11 48.11 0 0 1 3.478-.397m7.5 0v-.916c0-1.18-.91-2.164-2.09-2.201a51.964 51.964 0 0 0-3.32 0c-1.18.037-2.09 1.022-2.09 2.201v.916m7.5 0a48.667 48.667 0 0 0-7.5 0" />
              </svg>
        </button>
        <button className='bg-green-200 p-3 rounded-lg hover:bg-green-500 '>
            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="size-6">
